...
import {
  ...
  MATERIALS,
  MODELS,
} from "@/validators/optionValidator";
...
import { SaveConfigArgs, saveConfig as saveConfigAction } from "./actions";
...
const DesignConfigurator = ({
  ...
  return (
    <div className="relative mt-20 grid lg:grid-cols-3  mb-20 pb-20">
      <div
